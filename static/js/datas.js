...
const getJobsData = () => {
    const jobs = [
        {beginYear: "2019", endYear: "Present", company: "Atlas Quantum", role: "Senior Front-End Developer", local: "Sao Paulo / Sao Paulo - Brazil", description: "The largest crypto-currency company in Latin America.", url: "https://atlasquantum.com/", tools: "Angular, AWS, Firebase, Sass, JavaScript, Node.js, Materialize"},
