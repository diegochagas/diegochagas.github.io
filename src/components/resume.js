...
export default function Resume(){
	return(
		<section className="resume text-center">
			<div className="container">
				<div className="strip text-center">
					<a href="https://docs.google.com/document/d/1MNtyoAhvLY5H_Sy8gfAwZgpaMJ4dlOln7Nftb9InOw8/" target="_blank" rel="noopener noreferrer"><img src={iconDown} alt="icon download"/></a>
				</div>
				<div className="down">
