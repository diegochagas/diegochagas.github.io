...
export const softSkills: Skill[] = [
  {
    ...
    description: "Open-mindedness and adaptability to new ideas and feedback.",
  },
  {
    title: "Organised",
    description:
      "Methodical in task planning and execution, with strong time management abilities.",
  },
  {
    title: "Teamwork",
    description:
      "Effective communication, active listening, and sharing knowledge and experiences.",
  },
];
